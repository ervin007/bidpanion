...
FIELDS = [
    ...
    },
    {
        ...
        "instruction": (
            ...
            "(PT), total hours, EUR amount, ceiling values. Always prioritize "
            "the OVERALL TOTAL value of the tender over individual lot values. "
    ...
    },
    {
        ...
        "instruction": (
            ...
            "Capture mandatory disclosures even if no numeric threshold is "
            "set (e.g., if disclosure of turnover for 3 years is required "
            "without a floor). "
    ...
    },
    {
        ...
        "instruction": (
            ...
            "Capture the requirement for comparable turnover even if no "
            "numeric floor is set (mandatory disclosure). "
    ...
    # ── Technical & Professional Ability ─────────────────────────────
    {
        ...
        "instruction": (
            ...
            "Per role and per Los where applicable, capture the ACTUAL "
            "SKILL REQUIREMENTS (e.g., 'mind. 5 Jahre Erfahrung'), not just "
            "the rules on how to submit CVs. Capture: "
